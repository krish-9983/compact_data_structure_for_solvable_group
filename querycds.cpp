...
int main(int argc, char* argv[]) {
   ...
   std:: cout << "Total nodes      : " << ops.size() << "\n";
    ...
    std:: cout << "Inversions (I)   : " << num_inv   << " (" << (100.0 * num_inv   / ops.size()) << "%)\n";
    std:: cout << "Multiplications  : " << num_mul   << " (" << (100.0 * num_mul   / ops.size()) << "%)\n";
    std::cout << "C - M            : " << (num_const - num_mul) << " (must be 1 for a valid binary tree)\n";
